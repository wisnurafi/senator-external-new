...
#ifdef IMGUI_USER_EXTRA_STYLES
    ImGuiStyleVar_ChildPadding,             // ImVec2    ChildPadding
#endif
...
#ifdef IMGUI_USER_EXTRA_STYLES
    ImVec2      ChildPadding;               // Padding within a child.
#endif
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColorRounded(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0.0f, ImDrawFlags flags = 0);
